...
import com.example.memoraid.adapters.HabitCaretakerAdapter
import com.example.memoraid.databinding.FragmentHabitsCaretakerBinding
...
class HabitsCaretakerFragment : Fragment() {
    ...
    private lateinit var habitAdapter: HabitCaretakerAdapter
    ...
    override fun onCreateView(
        ...
        habitAdapter = HabitCaretakerAdapter(
            habits,
            date,
