...
import com.roxanasultan.memoraid.databinding.FragmentCardGameBinding
import com.roxanasultan.memoraid.models.Card
    ...
    private fun animateMatchedCards(firstButton: Button, secondButton: Button) {
        ...
        AnimatorSet().apply {
            playTogether(
                ...
                firstCardScaleY, secondCardScaleX, secondCardScaleY)
            addListener(object : Animator.AnimatorListener {
                override fun onAnimationStart(animation: Animator) {
