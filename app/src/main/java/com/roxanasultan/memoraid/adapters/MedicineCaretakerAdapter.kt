...
import com.roxanasultan.memoraid.databinding.ItemMedicineCaretakerBinding
import com.roxanasultan.memoraid.models.Medicine
import com.google.firebase.firestore.FirebaseFirestore
import com.roxanasultan.memoraid.R

class MedicineCaretakerAdapter(
    private val medicine: MutableList<Medicine>,
    private val onEditClick: (Medicine) -> Unit,
    private val onDeleteClick: (Medicine) -> Unit) :
    RecyclerView.Adapter<MedicineCaretakerAdapter.MedicineViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MedicineViewHolder {
        val itemBinding = ItemMedicineCaretakerBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class MedicineViewHolder(private val binding: ItemMedicineCaretakerBinding) :
    ...
    private fun updateLayout(completed: Boolean, binding: ItemMedicineCaretakerBinding) {
        if (completed) {
    ...
    private fun updateFontStyle(style: Int, binding: ItemMedicineCaretakerBinding) {
    ...
    private fun updateFontStyleLabels(style: Int, binding: ItemMedicineCaretakerBinding) {
